        ...
        $(function() {
            ...
            <div class="mt-2">`;
                            if (proj.totalinscritos == 0) {
                                ...
                                // htmlAbertos += `<a href="info_projeto_api.php?id=${proj.id_project}" class="btn btn-sm btn-primary w-100 mb-1">Acompanhe seu projeto</a>`;
                            }
                            htmlAbertos += `</div></div>`;
                        });
                    }
            ...
            <div class="mb-2"><small class="text-muted">Oportunidade:</small> <div>${proj.titulo_edital}</div></div>
            <div class="mt-2">
            <a href="info_projeto_api_dados.php?id=${proj.id_project}" class="btn btn-sm btn-primary w-100 mb-1">Acompanhe seu projeto</a>
            </div>
          </div>`;
                        });
                    }
